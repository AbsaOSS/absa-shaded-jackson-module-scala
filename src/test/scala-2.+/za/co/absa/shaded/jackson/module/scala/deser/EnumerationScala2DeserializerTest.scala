...
import za.co.absa.shaded.jackson.module.scala.{DefaultScalaModule, Weekday}
...
class EnumerationScala2DeserializerTest extends DeserializerTest {
  import za.co.absa.shaded.jackson.module.scala.deser.EnumerationDeserializerTest._
