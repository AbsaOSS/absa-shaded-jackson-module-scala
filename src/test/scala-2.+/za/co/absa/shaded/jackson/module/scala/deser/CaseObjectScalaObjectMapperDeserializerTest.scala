...
import za.co.absa.shaded.jackson.module.scala.deser.CaseObjectDeserializerTest.TestObject
import za.co.absa.shaded.jackson.module.scala.{DefaultScalaModule, ScalaObjectMapper}
