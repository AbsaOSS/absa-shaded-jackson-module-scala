...
import za.co.absa.shaded.jackson.annotation.JsonTypeInfo.{As, Id}
import za.co.absa.shaded.jackson.annotation.{JsonInclude, JsonProperty, JsonSubTypes, JsonTypeInfo}
import za.co.absa.shaded.jackson.core.JsonGenerator
import za.co.absa.shaded.jackson.databind.annotation.JsonSerialize
import za.co.absa.shaded.jackson.databind.{JsonSerializer, SerializationFeature, SerializerProvider}
