...
import za.co.absa.shaded.jackson.annotation.{JsonSubTypes, JsonTypeInfo}
import za.co.absa.shaded.jackson.core.`type`.TypeReference
import za.co.absa.shaded.jackson.module.scala.ser.TupleSerializerTest.OptionalTupleHolder
