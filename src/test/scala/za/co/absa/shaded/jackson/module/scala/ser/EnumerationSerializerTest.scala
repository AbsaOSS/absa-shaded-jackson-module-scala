package za.co.absa.shaded.jackson
package module.scala
package ser

import za.co.absa.shaded.jackson.core.`type`.TypeReference
import za.co.absa.shaded.jackson.jaxrs.json.JacksonJsonProvider
import za.co.absa.shaded.jackson.module.scala.OuterWeekday.InnerWeekday
import za.co.absa.shaded.jackson.module.scala.ser.EnumerationSerializerTest.Severity.Severity
...
class EnumerationSerializerTest extends SerializerTest {
  ...
  it should "serialize an Enumeration" in {
		val day = Weekday.Fri
		serialize(day) should be ("""{"enumClass":"za.co.absa.shaded.jackson.module.scala.Weekday","value":"Fri"}""")
	}

  it should "serialize an inner Enumeration" in {
    val day = InnerWeekday.Fri
    serialize(day) should be ("""{"enumClass":"za.co.absa.shaded.jackson.module.scala.OuterWeekday$InnerWeekday","value":"Fri"}""")
  }
  ...
  it should "serialize ErrorCode" in {
    val expected = """{"errorCode":"GEN001","severity":{"enumClass":"za.co.absa.shaded.jackson.module.scala.ser.EnumerationSerializerTest$Severity","value":"FAIL"}}"""
  ...
  it should "serialize inline ErrorCode" in {
    val expected = """{"errorCode":"inline","severity":{"enumClass":"za.co.absa.shaded.jackson.module.scala.ser.EnumerationSerializerTest$Severity","value":"INFORMATION"}}"""
