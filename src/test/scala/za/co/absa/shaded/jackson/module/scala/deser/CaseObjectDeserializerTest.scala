...
import za.co.absa.shaded.jackson.annotation.{JsonAutoDetect, PropertyAccessor}
import za.co.absa.shaded.jackson.databind.json.JsonMapper
import za.co.absa.shaded.jackson.module.scala.{ClassTagExtensions, DefaultScalaModule}
import za.co.absa.shaded.jackson.module.scala.deser.CaseObjectDeserializerTest.{Foo, TestObject}
