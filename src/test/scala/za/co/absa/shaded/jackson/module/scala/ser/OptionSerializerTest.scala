...
import za.co.absa.shaded.jackson.databind.jsontype.DefaultBaseTypeLimitingValidator
import za.co.absa.shaded.jackson.databind.node.JsonNodeType
import za.co.absa.shaded.jackson.databind.JsonNode
import za.co.absa.shaded.jackson.module.jsonSchema.JsonSchema
import za.co.absa.shaded.jackson.module.jsonSchema.factories.SchemaFactoryWrapper
import za.co.absa.shaded.jackson.module.scala.{DefaultScalaModule, JacksonModule, RequiredPropertiesSchemaModule}
