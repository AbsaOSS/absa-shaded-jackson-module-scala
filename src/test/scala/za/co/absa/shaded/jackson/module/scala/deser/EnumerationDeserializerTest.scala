...
import za.co.absa.shaded.jackson.module.scala.ser.EnumerationSerializerTest.{AnnotationHolder, AnnotationOptionHolder, WeekdayType}
import za.co.absa.shaded.jackson.module.scala.{DefaultScalaModule, JsonScalaEnumeration, Weekday}
...
class EnumerationDeserializerTest extends DeserializerTest {
  ...
  val fridayEnumJson = """{"day": {"enumClass":"za.co.absa.shaded.jackson.module.scala.Weekday","value":"Fri"}}"""

  val fridayInnerEnumJson = """{"day": {"enumClass":"za.co.absa.shaded.jackson.module.scala.OuterWeekday$InnerWeekday","value":"Fri"}}"""
