...
import za.co.absa.shaded.jackson.annotation.{JsonInclude, JsonProperty, JsonTypeInfo}
...
class IterableSerializerTest extends SerializerTest {
  ...
  it should "honor JsonTypeInfo" in {
    serialize(CHolder(Seq[C](X("1"), X("2")))) shouldBe """{"c":[{"@class":"za.co.absa.shaded.jackson.module.scala.ser.IterableSerializerTest$X","data":"1"},{"@class":"za.co.absa.shaded.jackson.module.scala.ser.IterableSerializerTest$X","data":"2"}]}"""
  }
