...
import za.co.absa.shaded.jackson.databind.{DeserializationFeature, JsonMappingException, ObjectMapper, ObjectReader, PropertyNamingStrategy}
import za.co.absa.shaded.jackson.module.scala.ser.{ClassWithOnlyUnitField, ClassWithUnitField}
...
class CaseClassDeserializerTest extends DeserializerTest {
  import za.co.absa.shaded.jackson.module.scala.deser.CaseClassDeserializerTest._
  ...
  it should "fail deserialization with missing field (DeserializationFeature.FAIL_ON_NULL_CREATOR_PROPERTIES)" in {
    ...
    val input = """{"hour": "12345"}"""
    intercept[za.co.absa.shaded.jackson.databind.exc.MismatchedInputException] {
