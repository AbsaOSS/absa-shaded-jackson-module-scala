...
import za.co.absa.shaded.jackson.core.{JsonGenerator, JsonToken}
...
import za.co.absa.shaded.jackson.databind.ser.impl.{PropertySerializerMap, UnknownSerializer}
import za.co.absa.shaded.jackson.databind.ser.std.StdSerializer
import za.co.absa.shaded.jackson.databind.ser.{ContextualSerializer, Serializers}
import za.co.absa.shaded.jackson.module.scala.modifiers.EitherTypeModifierModule
...
private class EitherSerializer(left: EitherDetails,
  ...
  import za.co.absa.shaded.jackson.module.scala.ser.OptionSerializer._
