...
import za.co.absa.shaded.jackson.core.{JsonParser, TreeNode}
...
trait ClassTagExtensions {
  ...
  /**
   * Convenience method for constructing [[za.co.absa.shaded.jackson.databind.JavaType]] out of given
   ...
   * In either case [[za.co.absa.shaded.jackson.core.JsonParser]] must point to the first token of
   * the first element, OR not point to any token (in which case it is advanced
   * to the next token). This means, specifically, that for wrapped sequences,
   * parser MUST NOT point to the surrounding <code>START_ARRAY</code> but rather
   * to the token following it.
   * <p>
   * Note that [[za.co.absa.shaded.jackson.databind.ObjectReader]] has more complete set of variants.
   */
  ...
  /**
   * Factory method for constructing [[za.co.absa.shaded.jackson.databind.ObjectWriter]] that will
  ...
  /**
   * Factory method for constructing [[za.co.absa.shaded.jackson.databind.ObjectReader]] that will
